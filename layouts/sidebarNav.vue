<template lang="pug">
    v-app(id="baseline")
        v-navigation-drawer(v-model="drawer" app dark mobile-breakpoin )  
            v-list(dense) 
                ...
                v-list-item(link to="/layoutSetting" nuxt) 
                        v-list-item-action 
                                v-icon  fas fa-th
                        v-list-item-content 
        ...
        v-app-bar(app) 
            ...
            v-toolbar-title Vuetify.js  
            v-spacer 
        v-main
            nuxt 
        v-footer(app)
            v-toolbar-title 
                span CSS Falmework Vuetify.js  
